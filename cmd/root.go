...
var RootCmd = &cobra.Command{
	Use:   "codedeploy-agent",
	Short: "codedeploy-agent - AWS CodeDeploy Agent",
	Long:  `codedeploy-agent - AWS CodeDeploy Agent`,
...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config_file", "", "config file (default is /etc/codedeploy-agent/conf/codedeployagent.yml)")
}
